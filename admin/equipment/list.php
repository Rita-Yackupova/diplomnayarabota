...
<body>
  <div class="table-title">
    <h3>Оборудование
      <form action="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=<?= $sort ?>&column=<?= $column?>">
  ...
  <table class="table-fill">
    ...
    <thead>
      ...
      <tr>
        ...
        <? if ($sort == "asc_title" and $column == "title") { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=title"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=title"><button>&#9660</button></a>
            <? } ?>
        </th>
        <th width="12%" class="text-left">Фирма, модель
        <? if ($sort == "asc_title" and $column == "manufacturer") { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=manufacturer"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=manufacturer"><button>&#9660</button></a>
            <? } ?>
        </th>
        ...
        <? if ($sort == "asc_title" and $column == "date") { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=date"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=date"><button>&#9660</button></a>
            <? } ?>
        </th>
        <th class="text-left">Гарантия до
        <? if ($sort == "asc_title" and $column == "guarantee_period") { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=guarantee_period"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=guarantee_period"><button>&#9660</button></a>
            <? } ?>
        </th>
        <th width="10%" class="text-left">Стоимость
        <? if ($sort == "asc_title" and $column == "price") { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=price"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/admin/equipment/list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=price"><button>&#9660</button></a>
            <? } ?>
        </th>
        ...
        <? if ($id_med_room != NULL) {
          ?>
          <th width="6%" class="text-left"><a href="create.php?id_med_room=<?= $id_med_room ?>"
    ...
    <tbody class="table-hover">
      ...
      foreach ($equipments as $equipment) {
        ...
        <tr>
          ...
          if ($id_med_room != NULL) {
            ?>
            <td class="text-left">
              <a href="update.php?id_med_room=<?= $id_med_room ?>&id=<?= $equipment[0] ?>">Изменить</a>
              <br>
              <a href="../php/equipment/delete.php?id=<?= $equipment[0] ?>">Удалить</a>
            </td>
          <? } ?>
        </tr>
        <?php
      ...
      <td>
        <a
          href="https://medin.bfuunit.ru/admin/equipment/export_excel_equipment.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=<?= $sort ?>&column=<?= $column ?>">Экспорт</a>
      </td>
    </tbody>
  </table>
</body>

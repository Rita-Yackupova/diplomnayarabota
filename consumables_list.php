...
<body>
  <div class="table-title">
    <h3>Расходные материалы
      <form
        action="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=<?= $sort ?>&column=<?= $column ?>">
    ...
    <table class="table-fill">
        ...
        <tr>
          ...
          <th class="text-left">Название
            <? if ($sort == "asc_title" and $column == "title") { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=title"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=title"><button>&#9660</button></a>
            <? } ?>
          </th>
          <th width="10%" class="text-left">Количество
            <? if ($sort == "asc_title" and $column == "amount") { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=amount"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=amount"><button>&#9660</button></a>
            <? } ?>
          </th>
          <th width="12%" class="text-left">Дата покупки
            <? if ($sort == "asc_title" and $column == "date") { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=date"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=date"><button>&#9660</button></a>
            <? } ?>
          </th>
          <th class="text-left">Срок годности
            <? if ($sort == "asc_title" and $column == "expiration_date") { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=expiration_date"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=expiration_date"><button>&#9660</button></a>
            <? } ?>
          </th>
          <th width="10%" class="text-left">Стоимость
            <? if ($sort == "asc_title" and $column == "price") { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=desc_title&column=price"><button>&#9650</button></a>
            <? } else { ?>
              <a
                href="https://medin.bfuunit.ru/consumables_list.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=asc_title&column=price"><button>&#9660</button></a>
            <? } ?>
          </th>
      ...
      <tbody>
        ...
        <td>
          <a href="https://medin.bfuunit.ru/export_excel_consumables.php?id_med_room=<?= $id_med_room ?>&search=<?= $search ?>&sort=<?= $sort ?>&column=<?= $column ?>">Экспорт</a>
        </td>
      </tbody>
    </table>
